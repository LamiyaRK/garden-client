...
const Login = () => {
    const {handlelogin,goSignup}=use(AuthContext)
  ...
  <button className='btn bg-[#0B3D2C] text-white mt-3  flex items-center' onClick={gRegister}><FaGoogle/> Login With Google</button>
